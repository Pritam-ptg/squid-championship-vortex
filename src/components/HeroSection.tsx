        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 reveal">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold leading-tight mb-6">
              ...
              <span className="text-squidPink"> Championship</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <a 
                href="#register" 
                className="bg-squidPink hover:bg-squidPink/90 text-white px-8 py-3 rounded-full font-medium transition-colors duration-300 text-center animate-pulse-glow"
              >
                Register Now
              </a>
              <a 
                href="#events" 
                className="bg-transparent border border-white/20 hover:border-white/40 text-white px-8 py-3 rounded-full font-medium transition-colors duration-300 backdrop-blur-sm text-center"
              >
                View Events
              </a>
            </div>
          ...
          <div className="md:w-1/2 mt-12 md:mt-0 reveal">
            <div className="relative w-full max-w-md mx-auto">
              ...
              <div className="relative glass-card rounded-lg p-1 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 px-3 py-1 bg-squidPink text-white text-xs rounded-full">
                  LIVE EVENT
                </div>
              </div>
            </div>
